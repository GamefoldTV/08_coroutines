...
import ru.netology.coroutines.entity.CommentsWithAuthor
import ru.netology.coroutines.entity.PostWithCommentsAndAuthor
...
private val BASE_URL = "http://192.168.1.146:9999"
...
suspend fun getCommentsWithAuthors(client: OkHttpClient, id: Long): List<CommentsWithAuthor> = coroutineScope {
        getComments(client, id).map { comment ->
            async {
                CommentsWithAuthor(
                    comment,
